...
- [Read RSOP Account Policy](#read-rsop-account-policy)
  - [RSOP_SecuritySettingBoolean](#rsopsecuritysettingboolean)
    - [KeyName](#keyname)
    - [Example](#example)
  - [RSOP_SecuritySettingString](#rsopsecuritysettingstring)
    - [KeyName](#keyname-1)
    - [Example](#example-1)
  - [RSOP_SecuritySettingNumeric](#rsopsecuritysettingnumeric)
    - [KeyName](#keyname-2)
    - [Example](#example-2)
